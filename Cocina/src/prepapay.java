...
public class prepapay extends JFrame{
    ...
    public prepapay (){
        ...
        //imagen
        JLabel i=new JLabel();
        i.setIcon(new ImageIcon(getClass().getResource("prepapay.png")));
        prin.add(i);
        i.setBounds(10,20,357,275);
         ...
         enlace.setBounds(180,335,190,30);
