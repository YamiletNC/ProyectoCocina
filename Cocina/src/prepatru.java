...
public class prepatru extends JFrame{
    ...
    public prepatru (){
        ...
        //imagen
        JLabel i=new JLabel();
        i.setIcon(new ImageIcon(getClass().getResource("pretru.png")));
        prin.add(i);
        i.setBounds(10,20,363,366);
         ...
         enlace.setBounds(180,390,190,30);
  
       prin.setBackground(Color.white);
       add(prin,BorderLayout.CENTER);
            setVisible(true);
            setResizable(false);
            setSize(415,470);//tamañño
